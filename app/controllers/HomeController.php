    ...
    public function addStats(){
        ...
        if ($data['password'] == "kanapkipo6"){
            ...
            foreach($matches as $key => $game){
                $localjsondata = json_decode(file_get_contents("https://osu.ppy.sh/api/get_match?k=".$this->apikey."&mp=".$game)); // get match data for each match played (in case of multi matches because of... something
