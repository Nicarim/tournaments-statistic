    ...
    public function addStats(){
        ...
        if ($data['password'] == "kanapkipo6"){
            ...
            $matchinfo = array(
                ...
                "teamA" => substr(substr(explode('vs',explode(':',$jsondata->match->name)[1])[0],2),-1),
                "teamB" => substr(substr(explode('vs',explode(':',$jsondata->match->name)[1])[1],2),-1)
            );
            return var_dump($matchinfo);
